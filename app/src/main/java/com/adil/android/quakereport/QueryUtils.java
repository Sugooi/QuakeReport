...
public final class QueryUtils {
     ...
     */
    public static ArrayList<QuakeList> extractEarthquakes() {
        ...
        try {
          ...
          {JSONObject root = new JSONObject(SAMPLE_JSON_RESPONSE);
           JSONArray features = root.getJSONArray("features");
              ...
              earthquakes.add(new QuakeList(properties.getDouble("mag"),properties.getString("place"),properties.getLong("time"),properties.getString("url")));
          }
